...
def feed_battle():
    ...
    dst = '%s_%s-%s_%s-%s.jpg' % (
        a_pic_name, a_score, b_pic_name, b_score, lang)
    composite_score(player_a, player_b, dst, lang, None)
